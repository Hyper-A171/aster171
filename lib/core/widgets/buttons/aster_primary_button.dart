...
/// Primary action button for Aster design system.
/// Uses Deep Indigo fill, white label, 12 px radius, and min height of 48.
class AsterPrimaryButton extends StatelessWidget {
  final String label;
